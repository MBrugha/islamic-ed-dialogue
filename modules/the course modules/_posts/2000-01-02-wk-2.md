...
**_Inquirers_**: You’re invited to join the MOOC this week after completing [a self-audit of your practice and your registration/consent form](https://docs.google.com/forms/d/e/1FAIpQLScefMoRYzS14tsLl5ID6tRHMvfWW4V6Jrg8JDuRvVheTGcuXQ/viewform?usp=sf_link).
<br/><br/>
## Focus of the week

Watch the following video series from top to bottom (there are 5 short videos in total) for an overview of the week's focus. _Please note that this and the other weekly videos were developed for the first live trial - there may therefore be references to live events or other activities which are irrelevant for the self-paced version._
...
* Self-audit for those in the inquirer strand: if you haven’t completed it already, please complete your [self-audit](https://docs.google.com/forms/d/e/1FAIpQLScefMoRYzS14tsLl5ID6tRHMvfWW4V6Jrg8JDuRvVheTGcuXQ/viewform?usp=sf_link) before engaging with the course materials.
...
* The above video can also be accessed from the [edudialogue.org site](https://www.edudialogue.org/resources/introductory-video-series/collection-1/#video1)
...
* The above video can also be accessed from the [edudialogue.org site](https://www.edudialogue.org/resources/introductory-video-series/collection-1/#video2)
...
* Videos 2 and 4 can also be accessed from the [edudialogue.org site](https://www.edudialogue.org/resources/introductory-video-series/)
* Self-audit for those in the inquirer strand: if you haven’t completed it already, please complete your [self-audit](https://docs.google.com/forms/d/e/1FAIpQLScefMoRYzS14tsLl5ID6tRHMvfWW4V6Jrg8JDuRvVheTGcuXQ/viewform?usp=sf_link) before engaging with the course materials.
...
Watch the following video on ground rules, which is also available as Video 3 on the edudialogue site: [Practical tips for supporting classroom dialogue: ground rules](https://www.edudialogue.org/resources/introductory-video-series/collection-1/#video3):
...
In the [week two discussion forum channel](https://www.edudialogue.org/forum/mooc-self-paced/week-two-revisiting-the-theories-and-impact-of-educational-dialogue-2/), you can post about your reflections from the readings and resources and the activities for the week – did you encounter any challenges? This can also include your responses to the examples of dialogue in the classroom in the weekly video where I asked you to write down ideas of how to strengthen the exchanges that took place.
