...
Watch the following video series from top to bottom (there are 4 short videos in total) for an overview of the week’s focus. _Please note that this and the other weekly videos were developed for the first live trial - there may therefore be references to live events or other activities which are irrelevant for the self-paced version._
